...
void Scratch::draw(SDL_Surface *surface, SDL_Rect clip)
{
  ...
  while (y < clip.y + clip.h)
  {
    ...
    if (lx >= clip.x && lx < clip.x + clip.w)
    { // Only draw within the clipping rectangle.
      // Get pixel...
