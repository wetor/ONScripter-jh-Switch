/* -*- C++ -*-
 *
 *  gles_renderer.h - GLES2 renderer for ONScripter (Nintendo Switch port)
 *
...
#if defined(SWITCH)
// Nintendo Switch uses OpenGL ES via mesa/nouveau
#include <EGL/egl.h>
#include <GLES2/gl2.h>
...
#else
// Desktop platforms - use SDL's OpenGL ES wrapper
...
#if !(defined(IOS) || defined(ANDROID) || defined(SWITCH))
    // Dynamic binding for desktop platforms
...
public:
    GlesRenderer(SDL_Window *window, SDL_Texture *texture,
